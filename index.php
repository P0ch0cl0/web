                        ...
                        <div class="col mb-2">
                            <form action="index.php" id="ordenForm" method="get">
                                ...
                                <select name="orden" id="orden" class="form-select form-select-sm"
                                    ...
                                    <option value="precio_alto"
                                        <?php echo ($orden === 'precio_alto') ? 'selected' : ''; ?>>Precio mas alto
                                    </option>
                                    <option value="precio_bajo"
                                        <?php echo ($orden === 'precio_bajo') ? 'selected' : ''; ?>>Precio mas bajo
                                    </option>
                                    <option value="asc" <?php echo ($orden === 'asc') ? 'selected' : ''; ?>>Nombre A-Z
                                    </option>
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-4">
                        ...
                        <div class="col">
                            <div class="card shadow-sm">
                                ...
                                ?>
                                <a
                                    href="details.php?id=<?php echo $row['id']; ?>&token=<?php echo hash_hmac('sha1', $row['id'], KEY_TOKEN);?>">
                                    <img src="<?php echo $imagen; ?>" class="d-block w-100" alt="Imagen">
                                </a>
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <a class="btn btn-success"
                                            onClick="addProducto(<?php echo $row['id']; ?>, '<?php echo hash_hmac('sha1', $row['id'], KEY_TOKEN);?>') ">Agregar Uno al Carrito</a>
                                    </div>
                                </div>
                            </div>
                        </div>
